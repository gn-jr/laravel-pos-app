...
class _$AddNominalPaymentImpl implements _AddNominalPayment {
  ...
  @override
  String toString() {
    return 'OrderEvent.addNominalPayment(nominal: $nominal)';
  }
...
class _$SuccessImpl implements _Success {
  ...
  @override
  String toString() {
    return 'OrderState.success(products: $products, totalQuantity: $totalQuantity, totalPrice: $totalPrice, paymentMethod: $paymentMethod, nominalPayment: $nominalPayment, idKasir: $idKasir, namaKasir: $namaKasir)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(products, totalQuantity, totalPrice, paymentMethod,
        nominalPayment, idKasir, namaKasir);
  }
